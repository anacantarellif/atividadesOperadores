...
let segundoNumero2 = Number(prompt("Digite outro numero!"))
...
console.log("A diferença das idade é", nome-nomeAmigo);

////

const par = Number(prompt("digite um número par"));
console.log(par%2); // todos os número pares vão dar 0 
